...
namespace TechVault.API.Services.Interfaces
{
    ...
    {
        Task<PaginatedList<ProductResponseDto>> GetAllProductsAsync(Guid? categoryId, decimal? minPrice, decimal? maxPrice, string? brand, bool? inStock, int pageNumber, int pageSize);
