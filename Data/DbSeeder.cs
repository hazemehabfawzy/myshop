    ...
    public static class DbSeeder
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            context.Products.AddRange(
                new Product { Id = Guid.NewGuid(), Name = "ASUS ROG STRIX RTX 4090 OC 24GB", Brand = "ASUS", Price = 54999, StockQuantity = 4, CategoryId = catGPU.Id, ImageUrl = "https://dlcdnwebimgs.asus.com/gain/A5C97B8A-D93F-4B36-9A0A-FBD7BD19D6F6/w717/h525", Description = "The ultimate GeForce GPU, bringing a quantum leap in performance, efficiency, and AI-powered graphics. Experience ultra-high performance gaming, incredibly detailed virtual worlds with ray tracing, and unprecedented productivity.", IsActive = true },
                new Product { Id = Guid.NewGuid(), Name = "MSI RTX 4080 Super 16G Gaming X Slim", Brand = "MSI", Price = 34999, StockQuantity = 7, CategoryId = catGPU.Id, ImageUrl = "https://asset.msi.com/resize/image/global/product/product_17001399478f2f36da3ab19eb29fefc1b63eafc3fa.png62405b38c58fe0f07fcef2367d8a9ba1/1024.png", Description = "A powerhouse GPU featuring a sleek, slimmed-down design without compromising on performance. Engineered with advanced cooling and high-speed memory to deliver fluid ray-traced graphics and stellar framerates.", IsActive = true },
                new Product { Id = Guid.NewGuid(), Name = "Sapphire NITRO+ RX 7900 XTX 24GB", Brand = "Sapphire", Price = 28999, StockQuantity = 5, CategoryId = catGPU.Id, ImageUrl = "https://www.sapphiretech.com/productimg/?image=aHR0cHM6Ly93d3cuc2FwcGhpcmV0ZWNoLmNvbS9tZWRpYWxpYi9wcm9kdWN0L3ByZW1pdW0vMTMzMDIvbWFpbl8xLmpwZw==", Description = "AMD's premier RDNA 3 graphics card, featuring massive 24GB VRAM and a striking vapor-chamber design. Delivers exceptional 4K gaming performance and incredible thermal efficiency under extreme workloads.", IsActive = true },
                ...
                new Product { Id = Guid.NewGuid(), Name = "AMD Ryzen 7 7800X3D", Brand = "AMD", Price = 9499, StockQuantity = 22, CategoryId = catCPU.Id, ImageUrl = "https://www.amd.com/content/dam/amd/en/images/products/processors/ryzen/2179262-ryzen-7-7800x3d-PIB-1260x709.png", Description = "Widely regarded as the absolute best gaming processor on the market, combining AMD's advanced Zen 4 architecture with massive 3D V-Cache for legendary in-game performance.", IsActive = true },
                new Product { Id = Guid.NewGuid(), Name = "Intel Core i9-14900K", Brand = "Intel", Price = 14999, StockQuantity = 12, CategoryId = catCPU.Id, ImageUrl = "https://www.intel.com/content/dam/www/central-libraries/us/en/images/2022-11/processors-core-i9-13900k-front-angle-rwd.png.rendition.intel.web.550.309.png", Description = "A powerhouse processor featuring 24 cores and jaw-dropping boost clocks of up to 6.0GHz. Built to satisfy enthusiasts, streamers, and creative professionals demanding top-tier multithreaded power.", IsActive = true },
                ...
                new Product { Id = Guid.NewGuid(), Name = "Lian Li PC-O11 Dynamic EVO XL", Brand = "Lian Li", Price = 4999, StockQuantity = 10, CategoryId = catCase.Id, ImageUrl = "https://www.lian-li.com/wp-content/uploads/2022/06/O11DEXL-1.png", Description = "A legendary full-tower dual-chamber showcase case designed to accommodate extreme watercooling configurations and multiple massive radiators while putting your high-end build on gorgeous display.", IsActive = true },
                new Product { Id = Guid.NewGuid(), Name = "NZXT H9 Flow", Brand = "NZXT", Price = 3199, StockQuantity = 16, CategoryId = catCase.Id, ImageUrl = "https://nzxt.com/assets/cms/34299/1673040369-h9-flow-pdp-black-main.png", Description = "A premium mid-tower ATX case with dual-chamber design and mesh panels for exceptional airflow, perfect for high-performance builds.", IsActive = true },
                new Product { Id = Guid.NewGuid(), Name = "NZXT Kraken Elite 360 LCD", Brand = "NZXT", Price = 7499, StockQuantity = 8, CategoryId = catCooler.Id, ImageUrl = "https://nzxt.com/assets/cms/34299/1643916217-kraken-elite-360-pdp-main.png", Description = "Premium 360mm AIO liquid cooler equipped with a high-resolution customizable LCD display on the pump head, allowing real-time system monitoring or custom GIF presentations.", IsActive = true },
                new Product { Id = Guid.NewGuid(), Name = "Samsung 990 Pro 2TB PCIe 5.0 NVMe", Brand = "Samsung", Price = 5499, StockQuantity = 20, CategoryId = catStorage.Id, ImageUrl = "https://images.samsung.com/is/image/samsung/p6pim/global/mz-v9p2t0bw/gallery/global-990-pro-mz-v9p2t0bw-thumb-535669040", Description = "A blazing-fast NVMe SSD with PCIe 5.0 interface, ideal for professionals and gamers who demand maximum read/write speeds and large storage capacity.", IsActive = true },
                new Product { Id = Guid.NewGuid(), Name = "WD Black SN850X 4TB NVMe", Brand = "WD", Price = 8999, StockQuantity = 12, CategoryId = catStorage.Id, ImageUrl = "https://m.media-amazon.com/images/I/61G4gTnASmL.jpg", Description = "A top-tier high-capacity NVMe drive engineered to eliminate loading times and deliver incredible gaming speeds. Outfitted with massive cache pools and robust endurance ratings.", IsActive = true }
            );
